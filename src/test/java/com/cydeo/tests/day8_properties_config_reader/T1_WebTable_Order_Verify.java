...
public class T1_WebTable_Order_Verify {
    ...
    public void test2(){
        ...
        System.out.println("customerOrderDate1 = " + customerOrderDate1);//customerOrderDate1 = 04/15/2021

        String customerOrderDate2 = WebTableUtils.returnOrderDate(driver, "John Doe");
        System.out.println("customerOrderDate2 = " + customerOrderDate2);//customerOrderDate2 = 01/08/2021
    }
